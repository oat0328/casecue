...
export default function EvidenceVault(){
  ...
  return <div><PageHeader title='ProofPort' subtitle='Turn student work into organized, teacher-reviewed evidence for Gradebook, IEP progress, and future IEP writing.' icon={Archive}/><Tabs defaultValue='batch'><TabsList className='mb-4'><TabsTrigger value='batch'>SmartStack Grader</TabsTrigger><TabsTrigger value='single'>QuickGrade</TabsTrigger></TabsList><TabsContent value='batch'><BatchWorkEvidencePanel students={students||[]} goals={goals||[]}/></TabsContent><TabsContent value='single'><WorkEvidencePanel students={students||[]} goals={goals||[]}/></TabsContent></Tabs></div>;
}
