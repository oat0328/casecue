...
export default function Register() {
  ...
  const handleGoogle = () => {
    base44.auth.loginWithProvider("google", safeReturnTo("/onboarding"));
  };
    ...
    <AuthLayout
      ...
      footer={
        <>
          ...
          <Link
            to={"/login" + (safeReturnTo("/onboarding") !== "/onboarding" ? "?returnTo=" + encodeURIComponent(safeReturnTo("/onboarding")) : "")}
