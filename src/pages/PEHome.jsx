...
import{Sparkles,BookOpen,CalendarClock,ScanLine}from'lucide-react';
...
export default function PEHome(){
 ...
 return <div className='space-y-6'>
  <section className='rounded-[30px] bg-slate-950 p-8 text-white'><div className='text-xs font-black uppercase tracking-[.2em] text-sky-300'>CaseCue PE</div><h1 className='mt-3 text-3xl font-black'>Stop hunting for another PE game.</h1><p className='mt-2 text-slate-300'>Grade + time + focus + equipment → a ready-to-run class. Schedule, lessons, and grading now use the shared CaseCue engines.</p></section>
