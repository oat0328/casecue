  ...
  <Tabs defaultValue="create">
   ...
   <TabsContent value="complete" className="space-y-4">
    ...
    {packet&&<div className="space-y-4">
     ...
     <div className="flex flex-wrap gap-2"><Button variant="outline" onClick={printPacket}><Printer className="mr-2 h-4 w-4"/>Print / Save Premium Packet</Button><Button onClick={send} disabled={busy}><Send className="mr-2 h-4 w-4"/>Send to Teacher</Button></div>
    </div>}
   </TabsContent>
  </Tabs>
 </div>;
