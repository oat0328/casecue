 ...
 const send=async()=>{
  ...
  try{
   ...
   try{
    ...
    toast({title:'Package saved — teacher routing still needs setup',description:'The assessment package is safely saved. Assign this student to a case manager for this Para account, then send the observation from Today & Capture.',variant:'destructive'});
   }
