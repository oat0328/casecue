...
import { GraduationCap, Plus, Trash2, UploadCloud, Download, FileSpreadsheet, Eye, FileText, TrendingUp, Users, ClipboardCheck, FolderOpen, Pencil, X } from "lucide-react";
...
export default function Gradebook() {
  ...
  return <div>
    <PageHeader title={workspaceKey==='para'?"Student Work":"Gradebook"} subtitle={workspaceKey==='para'?"Score work for students assigned to you, check CaseCue's results, and send the finished package to the teacher.":"GradeCue: load one assignment or a whole class stack, review only what needs attention, then file the final work to each student."} icon={GraduationCap} />
    ...
    <Tabs defaultValue="smart">
      <TabsList className="mb-4 flex flex-wrap h-auto"><TabsTrigger value="smart">{workspaceKey==='para'?'Score Work':'GradeCue'}</TabsTrigger><TabsTrigger value="manual">Manual Grade</TabsTrigger><TabsTrigger value="assignments">{workspaceKey==='para'?'Submitted Work':'Saved Grades'}</TabsTrigger>{workspaceKey!=='para'&&<TabsTrigger value="import">School Grade Import</TabsTrigger>}<TabsTrigger value="charts">Data & Trends</TabsTrigger><TabsTrigger value="reports">Reports & Exports</TabsTrigger></TabsList>
      ...
      {workspaceKey!=='para'&&<TabsContent value="import">
