...
export default function Gradebook() {
  ...
  const sourceLabel=a=>a.source_type==='manual_grade_entry'?'Manual grade':a.source_type==='teacher_manual_grade'?'Manual worksheet grade':a.source_type==='student_work_scan'?'Single uploaded work':a.source_type==='smart_grader_v2_teacher_assisted'?'Batch uploaded work':a.source_type==='gen_ed_import'?'School grade import':a.source_type==='para_smart_grader_submission'?'Para submission':String(a.source_type||'Grade record').replaceAll('_',' ');
