...
export default function SessionImportPanel({ students = [], goals = [], sessions = [], onImported }) {
  ...
  const needsReview = rows.filter(r => !r.duplicate && (!r.student_id || !r.date || r.delivered_minutes > 120)).length;
