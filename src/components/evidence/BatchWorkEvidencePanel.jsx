...
export default function BatchWorkEvidencePanel({students=[],goals=[],onSaved,v2=false,batchMode='guided',workspaceKey='sped'}){
 ...
 return<div className='space-y-5'>
  ...
  {flowStep==='decisions'&&<BatchDecisionQueue items={items} students={students} update={update} confirmStudent={confirmStudent} openEvidence={openEvidence} onApproveGrades={approveGradesAndCheckIep} approving={busy} submissionMode={isPara}/>}
