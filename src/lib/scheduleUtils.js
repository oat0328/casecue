...
export const DELIVERY_LABEL = { "pull-out": "Pull-Out", "push-in": "Push-In", consultation: "Consultation", class: "Class Context", session: "Session", support: "Student Support", other: "Other" };
